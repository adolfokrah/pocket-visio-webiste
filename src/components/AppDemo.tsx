  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: color, animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
...
export function AppDemo({ color = '#06b6d4' }: { color: string }) {
        ...
        <div className="p-4">
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            ...
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              <div>1D</div>
              <div>5D</div>
              <div className="font-semibold text-cyan-600" style={{ color }}>
                1M
              </div>
              <div>6M</div>
              <div>1Y</div>
            ...
            <div
              className="mt-4 rounded-lg bg-cyan-500 px-4 py-2 text-center text-sm font-semibold text-white"
