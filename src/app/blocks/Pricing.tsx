    ...
    >
      ...
      >
        {
          <>
            ...
            >
              <Text
                propName={`plans.${index}.price.Monthly`}
                pageBlockId={pageBlockId}
            ...
            >
              <Text
                propName={`plans.${index}.price.Annually`}
                pageBlockId={pageBlockId}
                defaultValue={price.Annually}
              />
            </span>
          </>
        }
      ...
      <div className="order-last mt-6">
        <List
          ...
          propName={`plans.${index}.features`}
          pageBlockId={pageBlockId}
          listItemClassName="flex py-2"
          className={clsx(
            ...
            <>
              ...
              <span className="ml-4">
                <Text
                  ...
                  propName={`plans.${index}.features.${featureIndex}`}
                />
              </span>
            </>
          )}
      ...
      >
        <Text
          propName={`plans.${index}.button.label`}
          pageBlockId={pageBlockId}
...
const Pricing: Block<PricingProps> = ({
  title,
  description,
  plans,
  pageBlockId = '',
  ...
  lists: [
    {
      ...
      subLists: [
        {
          propName: 'plans.features',
          label: 'Feature',
          defaultValue: 'Commission-free trading',
        },
      ],
    },
  ],
