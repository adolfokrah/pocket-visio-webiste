        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              ...
              >
                ...
                <span className="ml-2.5">
                  <Text
                    propName={'watchVideoCTAText'}
                    pageBlockId={pageBlockId}
                    defaultValue={watchVideoCTAText}
                  />
                </span>
              </Button>
            </div>
          ...
          <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
            <p className="text-center text-sm font-semibold text-gray-900 lg:text-left">
              <Text
                propName={'featuredInTitle'}
                pageBlockId={pageBlockId}
                defaultValue={featuredInTitle}
              />
            </p>
...
Hero.Schema = {
  ...
  defaultPropValues: {
    color: { colorHex: '#06b6d4', colorName: 'Cyan', id: 'Cyan' },
    title: 'Invest at the perfect time.',
    subTitle: `By leveraging insights from our network of industry insiders,
              you’ll know exactly when to buy to maximize profit, and exactly
              when to sell to avoid painful losses.`,
    features: [],
    featuredInTitle: 'As featured in',
    watchVideoCTAText: 'Watch the video',
  },
  lists: [
    {
      propName: 'features',
